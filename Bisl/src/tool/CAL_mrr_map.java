...
public class CAL_mrr_map {
    public static void main(String[] args) throws IOException {
        String query = "match (n:issues{name:$name})-[:solve]->(m:javaFile) return m.name";
        String workdir = "D:\\Bug_location\\process\\AfterDelete\\Apache\\Locus_FLINK";
        File work = new File(workdir);
        File[] listFiles = work.listFiles();
        BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("D:\\Bug_location\\process\\AfterDelete\\Apache\\LocusOutput_flink.txt"));
